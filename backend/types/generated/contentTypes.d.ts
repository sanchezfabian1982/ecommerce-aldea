...
export interface ApiPedidoPedido extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    comprobante_pago: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    detalle_items: Schema.Attribute.JSON & Schema.Attribute.Required;
    direccion_entrega: Schema.Attribute.Text & Schema.Attribute.Required;
    estado_despacho: Schema.Attribute.Enumeration<
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'pendiente_verificacion'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pedido.pedido'
    ...
    metodo_pago: Schema.Attribute.Enumeration<
      ['deposito_bancario', 'transferencia']
    > &
      Schema.Attribute.Required;
    nota_despacho: Schema.Attribute.Text;
    observacion_pago: Schema.Attribute.Text;
    productos: Schema.Attribute.Relation<
      'manyToMany',
      'api::producto.producto'
    >;
    publishedAt: Schema.Attribute.DateTime;
    telefono_contacto: Schema.Attribute.String & Schema.Attribute.Required;
    total: Schema.Attribute.Decimal & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vendedora: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    pedidos_cliente: Schema.Attribute.Relation<
      'oneToMany',
      'api::pedido.pedido'
    >;
    pedidos_vendedora: Schema.Attribute.Relation<
      'oneToMany',
      'api::pedido.pedido'
    >;
    ...
    publishedAt: Schema.Attribute.DateTime;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
    rol_tienda: Schema.Attribute.Enumeration<['cliente', 'vendedora']>;
    role: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.role'
    >;
